    ...
    while (PC < MAX)
    {
        ...
        if (aux <= 50)
        {
            ...
            case 0: // WriteCall
                ...
                snprintf(appAtual->syscall.call.writecall.path, sizeof(appAtual->syscall.call.writecall.path), "mydir/file_write_%d.txt", getpid());
            ...
            case 1: // ReadCall
                ...
                snprintf(appAtual->syscall.call.readcall.path, sizeof(appAtual->syscall.call.readcall.path), "teste/mydir/file_read_%d.txt", getpid());
            ...
            case 2: // AddCall
                ...
                snprintf(appAtual->syscall.call.addcall.path, sizeof(appAtual->syscall.call.addcall.path), "mydir/dir_add_%d", getpid());
            ...
            case 3: // RemCall
                ...
                snprintf(appAtual->syscall.call.remcall.path, sizeof(appAtual->syscall.call.remcall.path), "mydir/dir_remove_%d", getpid());
            ...
            case 4: // ListDirCall
                ...
                snprintf(appAtual->syscall.call.listdircall.path, sizeof(appAtual->syscall.call.listdircall.path), "mydir/dir_list_%d", getpid());
